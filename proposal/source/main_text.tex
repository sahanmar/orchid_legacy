...
\subsection*{WP2: Active-Learning-powered Multilingual Data Corpora Creation}
 ...
 {\color{green}
  Recently published multilingual corpus for Czech and other 11 languages \cite{cr-mult-Nedoluzhko2021} extends the limits for creation of new models with respect to new datasets. 
 However, our objective of the research is the creation of new Active-Learning-Boosted Czech and Slovak datasets optimised for Machine Learning purposes. The benefit of the work package is based not only in development of a new corpus but also in applying the active learning techniques that will reduce the efforts of the annotators and improve the quality of the resulted data. The suggested approach can be easily used for benchmarks with our neural models.
 }
